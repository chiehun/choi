...
public static DeptClass[] depts= new DeptClass[4];
public static EmpClass[] emps= new EmpClass[14];
	public DateClass() {// 기본 생성자는 사용 안함/...
	}

	public static void initDept() {
		depts[0]=new DeptClass("10", "경리부", "서울");
		depts[1]=new DeptClass("20", "인사부", "인천");
		depts[2]=new DeptClass("30", "영업부", "용인");
		depts[3]=new DeptClass("40", "전산부", "수원");
