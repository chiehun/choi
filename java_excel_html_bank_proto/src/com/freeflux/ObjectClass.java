...
public class ObjectClass {
	...
	public ObjectClass(String no, String age, String job, String marital, String education, String housing, String loan,
		...
		this.job = jobToKor(job);
		this.marital = maritalToKor(marital); // 메서드를 통해서 한글로 변환시켜 놓은 것
...
/**직업**/
	private String jobToKor(String job) {
		switch (job){	
	...
	private String day_of_weekToKor(String day_of_week) {
		switch (day_of_week) {//1.7 이하 버전에서는 숫자 밖에 받지 못한다.
		case "sun":
			return "일요일";
		case "mon":
			return "일요일";
